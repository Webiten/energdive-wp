...
/* =========================================================
   RECOMMENDED REPORTS SECTION (BOOTSTRAP-LIKE GRID)
========================================================= */
...
/* ===== IMAGE (PORTRAIT FIXED RATIO) ===== */
.recommended-thumb {
  position: relative;
  width: 100%;
  aspect-ratio: 6.5 / 7.5; /* PORTRAIT RATIO */
  overflow: hidden;
}
...
/* Tablets / Large mobiles (≤ 991px) → 2 columns */
...
<div align="center">
    <a 
      ...
      target="_blank"
      style="color:#fff; background:#a8be73; padding:6px 18px; text-decoration:none; font-size:14px; font-weight:bold; border-radius:5px;"
    >
      Download Report
    </a>
</div>
           ...
           <?php endif; ?>
            ...
            <?php if (get_field('sidebar_image')): ?>
                <div class="article-third-image">
                    ...
                    <div style="margin-top:15px; padding:15px;" align="center">
            ...
            <div class="recommended-card">
                <a href="<?php the_permalink(); ?>">
                    ...
                    <div class="recommended-content">
                        <h3 class="recommended-heading"><?php the_title(); ?></h3>
                        <p class="recommended-meta">
                            Team ENERGDIVE | <?php echo get_the_date('F j, Y'); ?>
                        </p>
                    </div>
