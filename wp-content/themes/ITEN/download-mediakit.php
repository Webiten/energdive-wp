<?php
/* Template Name: Download Media Kit */
get_header();
?>
...
<section class="media-kit-section">
  <div class="media-container">
    ...
    <h1>Download Media Kit</h1>

    <p class="media-text">
      Get official Energdive logos, media kits, and brand materials. Approved resources for editorial,
      promotional, and communications use.
    </p>

    <div class="iframe-wrapper">
      <iframe aria-label='Energdive - Website Form'
        frameborder="0"
        src='https://forms.zohopublic.in/itenmedia1/form/ENERGDIVEEnquiriesForm/formperma/vGdZ0noLDdoGdPS8QIhuH69flKMawpU27Ws-TttbC1A?QueryType=Brochure%20Download'>
      </iframe>
    </div>
