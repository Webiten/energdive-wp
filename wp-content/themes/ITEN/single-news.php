...
<div class="banner-author-wrap">
    ...
    <!-- Ad Section -->
    <!--<div class="author-ad-wrap">
        <div class="author-ad-box">
            <img src="YOUR-AD-IMAGE.jpg" alt="Advertisement">
        </div>
    </div>-->
</div>
                ...
                <a href="<?php the_permalink(); ?>">
                    ...
                    <div class="recommended-content">
                        ...
                        <p class="recommended-meta">
                            By ENERGDIVE | <?php echo get_the_date('F j, Y'); ?>
                        </p>
                    </div>
