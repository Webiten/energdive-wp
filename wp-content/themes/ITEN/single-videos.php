...
<style>
  ...
  .energ-single-wrap{
    background: radial-gradient(1200px 600px at 15% 10%, rgba(122,162,255,.18), transparent 60%),
                radial-gradient(900px 500px at 85% 12%, rgba(159,122,255,.12), transparent 65%),
                linear-gradient(180deg, var(--bg), #050814 45%, #040611);
    color: var(--text);
  ...
  .energ-content p{ color: rgba(255,255,255,.82); line-height: 1.8; }
