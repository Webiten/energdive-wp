...
<?php get_header(); ?> <?php $issue_id = get_queried_object_id(); $monthyear = get_field('issue_month-year', $issue_id); $volume = get_field('volume', $issue_id); $number = get_field('number', $issue_id); ?>
...
<div class="sip">
    <div class="issue-layout">
        ...
        <div class="issue-left">
            ...
            <h2 class="issue-heading">ENERGDIVE Insights and Market Intelligence</h2>
            <?php
    ...
    <h1><?php echo esc_html(get_the_title($issue_id)); ?></h1>
</div>
