...
<div class="aurora-auth-wrapper">
    ...
    <div class="aurora-auth-card">
        ...
        <div class="auth-subtext">
            Don’t have an account? <a href="#" style="color:#0066ff;">Sign up</a>
        </div>
        ...
        <div id="phone-section" class="auth-tab-content">
            ...
            <div class="mode-toggle">
                ...
                <div class="mode-option" data-mode="phone-pass">Password Login</div>
            </div>
            ...
            <!-- PASSWORD MODE -->
            <div id="phone-pass-box" style="display:none;">
                <input type="password" id="phone_password" placeholder="Password">
                <button class="main-btn" id="login-phone-pass">Login</button>
            </div>
        ...
        <div id="email-section" class="auth-tab-content" style="display:none;">
            ...
            <div class="mode-toggle">
                ...
                <div class="mode-option" data-mode="email-pass">Password Login</div>
            </div>
            ...
            <!-- EMAIL PASSWORD -->
            <div id="email-pass-box" style="display:none;">
                <input type="password" id="email_password" placeholder="Password">
                <button class="main-btn" id="login-email-pass">Login</button>
            </div>
